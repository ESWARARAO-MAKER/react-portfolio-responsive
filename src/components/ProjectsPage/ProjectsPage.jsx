        ...
        <div className="projects">
            ...
            <div className="projects-container">
                <div className="project-card" style={{"--i":1}}>
                    ...
                    <a href="https://eswar-covid-dash-board.netlify.app/" rel="noreferrer" target="_blank"><img src="/image/p2.png" alt= "img" className="covid-img"/></a>
                ...
                <div className="project-card" style={{"--i":2}}>
                    ...
                    <a href="https://eswar-hotel-booking.netlify.app/" rel="noreferrer" target="_blank"><img src="/image/img/p3.jpg" alt= "img" className="covid-img"/></a>
